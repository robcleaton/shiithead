          ...
          <div className="space-y-6 text-karma-foreground">
            ...
            >
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong>8:</strong> Can be played on any card regardless of rank. Skip the next player's turn (window card).</li>
              ...
              <p className="mt-2 italic text-sm text-karma-foreground/70">Note: Special card rules are implemented in this version of the game.</p>
            </motion.section>
