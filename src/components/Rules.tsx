        ...
        <ScrollArea className="max-h-[70vh] pr-4">
          <div className="space-y-6 text-karma-foreground">
            ...
            >
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>On your turn, you must play a card that matches the rank of the top card on the discard pile, or play a special card (2, 3, 7, 8, 10).</li>
            ...
            >
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong>8:</strong> Can be played on any card regardless of rank. Skip the next player's turn.</li>
              ...
              <p className="mt-2 italic text-sm text-karma-foreground/70">Note: The 7 and 10 special card rules are currently implemented. Other special cards may have limited functionality in this version of the game.</p>
            </motion.section>
